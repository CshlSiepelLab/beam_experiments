...
df_long = pd.melt(df, id_vars=['dir_name', 'migration'], value_vars=['random_f1', 'consensus_f1', 'machina_f1', 'beast_mcc_f1', 'beast_posterior_f1'])
...
textsize=22
fig, ax = plt.subplots(nrows=1, ncols=1, figsize=(12, 6))
sns.boxplot(x='variable', y='value', data=df_long, width=0.5, hue='migration', hue_order=['mS','pS','pM','pR'])
plt.ylabel("F1 Score", fontsize=textsize)
plt.xlabel("")
plt.xticks(fontsize=textsize, rotation=-45)
plt.yticks(fontsize=textsize)
