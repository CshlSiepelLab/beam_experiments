...
bar2 = ax.bar([i + bar_width for i in index], grouped['downsample_num_asvs'], bar_width, label='Downsampled')
...
ax.set_xticklabels([f"{row['mouse']}-{row['cp']}" for _, row in grouped.iterrows()], rotation=90)
