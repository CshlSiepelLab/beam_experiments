...
threshold_file = "/grid/siepel/home_norepl/staklins/bayesian_phylogenetic_metastasis/results/snakemake_performance_2_20_25_uniform_50cells_50sites_data_7_24_24/precision_recall_curve/beam_all_threshold_stats.csv"
...
sns.scatterplot(
    x="Threshold", y="f1", data=df, size=0.5, alpha=0.25, color="grey", legend=False
)
