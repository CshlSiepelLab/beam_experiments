...
sns.boxplot(x='model', y='marginal_likelihood', width=0.5, data=df, boxprops=dict(facecolor='none', edgecolor='black'), showfliers=False)
sns.stripplot(x='model', y='marginal_likelihood', data=df, jitter=True, size=5, color='grey', legend=False)
