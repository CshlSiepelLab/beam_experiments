...
strip_plot = sns.stripplot(x='mmus', y='information', data=data, color='grey', size=7.5, jitter=True, alpha=0.5)
box_plot = sns.boxplot(x='mmus', y='information', data=data, palette=DEFAULT_COLORS, showcaps=True, boxprops=dict(facecolor="none", edgecolor="black"), whiskerprops=dict(color="black"), fliersize=0)
