...
infile = "/grid/siepel/home_norepl/staklins/bayesian_phylogenetic_metastasis/results/yang_2022_real_data_8_22_24/downsampling_tip_counts.csv"
outfile = "/grid/siepel/home_norepl/staklins/bayesian_phylogenetic_metastasis/results/yang_2022_real_data_8_22_24/downsampling_tip_counts.pdf"
...
for name, group in grouped:
    first_below_threshold = group[group['Count'] <= max_tips].head(1)
    if not first_below_threshold.empty:
        index = first_below_threshold.index[0]
        # print(f"Sample: {name}, Index: {index}, Count: {first_below_threshold['Count'].values[0]}")
