...
plt.xlabel('Expected (BEAST - parsimony)\nmigration count difference', fontsize=fontsize)
...
plt.tight_layout()
outfile = csv_file.replace('.csv', '_difference_means_histogram.png')
plt.savefig(outfile)
plt.close()
