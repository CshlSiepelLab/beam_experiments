...
sns.heatmap(rate_matrix_primary_zero, xticklabels=tissues, yticklabels=tissues, annot=True, fmt='', cmap=cmap_null, cbar=False, ax=axes[0], annot_kws={"size": fs})
...
sns.heatmap(rate_matrix_labels, xticklabels=tissues, yticklabels=tissues, annot=True, fmt='', cmap=cmap_alt, cbar=False,  ax=axes[1], annot_kws={"size": fs})
