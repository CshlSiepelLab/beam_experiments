...
def read_file_to_list_of_tuples(file_path):
    ...
    for parent, child in data:
        parent_name = node_num_to_name[parent] + "_" + color_code_to_tissue[node_num_to_color_code[parent]]
        child_name = node_num_to_name[child] + "_" + color_code_to_tissue[node_num_to_color_code[child]]
