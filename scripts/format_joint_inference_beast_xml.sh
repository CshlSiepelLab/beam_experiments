...
# tisue rates for asym model
REPLACE_NUM_TISSUE_RATES=$(( REPLACE_NUM_TISSUES * (REPLACE_NUM_TISSUES - 1) / 2 ))
...
sed -i "s|REPLACE_NUM_TISSUE_RATES|$REPLACE_NUM_TISSUE_RATES|g" $XML_FILE
