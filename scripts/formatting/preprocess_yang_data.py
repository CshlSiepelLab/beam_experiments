...
### PREPROCESSING
###################
allele_filepath = "//grid/siepel/home/staklins/stored_data/crispr_barcode_related_data/yang_2022_real_data/metadata/KPTracer.alleleTable.FINAL.txt"
outdir = "//grid/siepel/home/staklins/stored_data/crispr_barcode_related_data/yang_2022_real_data/processed_metadata"
...
allele_df["tissue"] = [
    "".join(filter(str.isalpha, name[2])) for name in allele_df["Tumor"].str.split("_")
]
