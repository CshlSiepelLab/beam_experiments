...
char_matrix_df, priors, mut_dict = cas.pp.convert_alleletable_to_character_matrix(
    group, missing_data_state="-1", allele_rep_thresh=0.95, mutation_priors=indel_priors
)
successive_matrix, new_mut_dict, successive_edit_rates = convert_matrix_to_successive(
    char_matrix_df, mut_dict, indel_priors
)
