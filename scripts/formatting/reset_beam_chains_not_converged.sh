...
for cp in $(seq 3 9); do
    for i in $(seq 1 3); do
        terminal_files=$(find /grid/siepel/home/staklins/bayesian_phylogenetic_metastasis/results/in_vitro_data_4_24_25/beam_gtr${i}/inVitro/CP00${cp} -type f -name "terminal*")
        ess_above_200=false
