...
pipeline_run_name="joint_inference_vs_cassiopeia_machina_vs_random_cellTree_simdataset_5_2_24"
...
parallel --progress -j 40% --memfree 10G --memsuspend 10G < "${pipeline_run_name}/parallel.txt"
