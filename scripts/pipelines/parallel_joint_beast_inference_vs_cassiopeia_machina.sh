...
echo "dir_name,machina_f1,beast_mcc_f1,beast_posterior_f1,random_f1,consensus_f1,ess_convergence,migration_count,cas_rf_dist,shannon_mut_matrix" > $accuracy_file
