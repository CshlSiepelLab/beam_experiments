...
main_dir="/grid/siepel/home/staklins/projects/crispr_barcode/results/beam/latest_results/yang_results_2022_lung_cancer_data" 
...
# Write header
echo "name,gtr_ml,gtr_sd,random_ml,random_sd,bf(gtr-random),diff_threshold_random" > $outfile
...
for file in $files; do
    ...
    gtr_ml=""; gtr_sd=""; random_ml=""; random_sd=""; beam_bf_random=""; diff_threshold_random=""
    ...
    # Write to outfile
    echo -e "$name,$gtr_ml,$gtr_sd,$random_ml,$random_sd,$beam_bf_random,$diff_threshold_random" >> $outfile
done
...
# # ### Separate from above
# # # Reset come cps
# cps=(3457_Apc_T1 3457_Apc_T4 3508_Apc_T2 3513_NT_T1 3519_Lkb1_T1)
# for cp in "${cps[@]}"; do
#     rm ${main_dir}/beam_gtr_ns/${cp}/combined_terminal.log
#     rm ${main_dir}/beam_gtr_ns/${cp}/combined.log
#     rm ${main_dir}/beam_random_ns/${cp}/combined_terminal.log
#     rm ${main_dir}/beam_random_ns/${cp}/combined.log
# done
